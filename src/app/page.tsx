  ...
  return (
    <main className="min-h-screen bg-white flex flex-col text-gray-900">
      ...
      <section className="flex flex-col items-center justify-center text-center mt-20 px-6">
        ...
        {/* ONLY centered button */}
        <Link
          href="/signup"
          className="inline-flex items-center gap-2 bg-blue-800 text-white px-6 py-3 rounded-lg font-medium text-lg hover:bg-blue-900 transition"
        >
      ...
      <footer className="border-t border-gray-200 py-6 mt-auto text-center text-sm text-gray-500">
        <p>© {new Date().getFullYear()} VC-scenario. All rights reserved.</p>
        <div className="flex justify-center space-x-6 mt-2">
          <Link href="/privacy" className="hover:text-blue-800 transition">
            Privacy Policy
          </Link>
          <Link href="/terms" className="hover:text-blue-800 transition">
            Terms of Service
          </Link>
        </div>
      </footer>
